...
public class EmployeeProcess {
	...
	private static boolean isPersonExists(Session session, String userId, Long phone, String email) {
		// Check if a person with the same ID, phone, email, or employee ID already
		// exists
		...
		try (SessionFactory factory = configuration.buildSessionFactory()) {
			try (Session session = factory.openSession()) {
				...
				if (employee != null) {
					...
					switch (option) {
					case 1:
						int newSalary = inputProcess.getInt("Enter new Salary: ");
		...
		if (person != null) {
			...
			try {
				...
				case 1:
					...
					String newName = inputProcess.getString("");
					person.setName(newName);
					break;
				case 2:
					System.out.print("Enter new Email: ");
					String newEmail = inputProcess.getString("");
					person.setEmail(newEmail);
					break;
				case 3:
					System.out.print("Enter new Age: ");
					int newAge = inputProcess.getInt("");
					person.setAge(newAge);
					break;
				case 4:
					System.out.print("Enter new Address: ");
					String newAddress = inputProcess.getString("");
					person.setAddress(newAddress);
					break;
				case 5:
					System.out.print("Enter new Phone: ");
					Long newPhone = inputProcess.getLong("");
					person.setPhone(newPhone);
					break;
				case 6:
					System.out.print("Enter new User ID: ");
					String newUserId = inputProcess.getString("");
					person.setUserId(newUserId);
					break;
				case 7:
					System.out.print("Enter new Password: ");
					String newPassword = inputProcess.getString("");
